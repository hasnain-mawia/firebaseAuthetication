  ...
  return detailview === null ? <CLoader/> : (
    <div className='max-w-[1200px] mx-auto my-10'>
       ...
       <div className='grid grid-cols-1 sm:grid-cols-2'>
            ...
            <div>
                <h2 className='font-bold text-[18px] border-b-[2px] border-[black] dark:border-[white] pb-3'>{detailview.title}</h2>
                <p className='my-5'>{detailview.description}</p>
                <p className='text-[red] font-bold'>Category: {detailview.category}</p>
                <p className='text-[green] dark:text-[white] font-bold text-[22px]'>${detailview.price}</p>
